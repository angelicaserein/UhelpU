...
export class Level10 extends BaseLevel {
  ...
  _buildRooms(p) {
    ...
    const room4 = new Room([new Ground(0, 0, p.width, 80)], {
      left: { targetRoomIndex: 3 },
      right: { targetRoomIndex: 5 },
    });

    // room5: 右墙 + 地面 + 传送门，左侧出口
    ...
    const room5 = new Room(
      ...
      { left: { targetRoomIndex: 4 } },
    );

    return [room0, room1, room2, room3, room4, room5];
  }
