  ...
  _buildRooms(p) {
    ...
    const room0 = new Room(
      [
        ...
        new Enemy(526, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(548, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(550, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(546, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(550, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(530, 80, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(822, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(806, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(818, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(818, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(814, 430, 40, 40, { speed: 2, direction: 1 }),
        ...
        new Enemy(768, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(742, 430, 40, 40, { speed: 2, direction: 1 }),
        new Enemy(460, 80, 40, 40, { speed: 2, direction: 1 }),
