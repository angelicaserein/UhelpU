...
registerTranslations({
  en: {
    ...
    tutorial_guide_record_msg:
      "Please follow the operation prompts on the Phantom System and try the capture operation!",

    // ── PHASE 2: Guide Timeline ────────────────────────────────────
    tutorial_guide_timeline_msg:
      "You have 5 seconds to record. Press any movement key to start!",

    // ── PHASE 3: Recording ─────────────────────────────────────────
    tutorial_recording_msg:
      "Now try to move! You can see your actions being captured. Press the capture key again to stop early.",

    // ── PHASE 4: Guide Replay ──────────────────────────────────────
    tutorial_guide_replay_msg:
      "Follow the replay key hint to watch your phantom replay!",
    ...
    tutorial_phantom_replaying_label:
      "Your phantom is replaying your recorded actions!",

    // ── PHASE 6: Complete ──────────────────────────────────────────
    tutorial_complete_msg:
      "Great! Now use your newfound skills to complete the level!",
  ...
  zh: {
    // ── PHASE 1: Guide Record ──────────────────────────────────────
    tutorial_guide_record_msg:
      "请按照幻影系统上的操作提示，尝试一下捕捉操作吧！",

    // ── PHASE 2: Guide Timeline ────────────────────────────────────
    tutorial_guide_timeline_msg:
      "你一共有 5 秒的时间可以录制你自己的操作，按移动、跳跃或任意键继续！",

    // ── PHASE 3: Recording ─────────────────────────────────────────
    tutorial_recording_msg:
      "现在可以尝试移动！你可以看见你的动作正在被捕捉，并且也可以再按一次捕捉键来提前结束捕捉。",
